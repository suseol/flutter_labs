# Lab 03: Campus Dashboard

기본 화면에서 시작해 헤더, 소개 영역, 시설 카드를 단계별로 완성하는 Flutter UI 실습.

## 준비

자신의 Flutter 프로젝트에 `lib/main.dart`와 `assets/`를 복사. [pubspec.yaml](./pubspec.yaml)을 참고해 `assets/images/`를 등록한 뒤 `flutter pub get` 실행.

## 체크포인트

수업 중 놓친 경우 교수자가 안내한 체크포인트를 사용.
